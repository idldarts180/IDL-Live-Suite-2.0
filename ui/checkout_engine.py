"""IDL Live Suite - Dart-aware Checkout Engine"""
...
135:"BULL · T15 · D20",134:"T20 · T14 · D16",133:"T20 · T19 · D8",132:"BULL · BULL · D16",
...
def get_checkout(score, darts_remaining=3):
    try:
        score = int(score)
        darts_remaining = int(darts_remaining)
    except (TypeError, ValueError):
        return ""

    route = CHECKOUTS.get(score, "")
    if not route or darts_remaining <= 0:
        return ""

    darts_needed = len(route.split(" · "))
    return route if darts_needed <= darts_remaining else ""